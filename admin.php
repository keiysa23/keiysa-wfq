...
if (isset($_POST['bsimpan'])) {
    ...
    $nokamar = htmlspecialchars($_POST['nokamar'], ENT_QUOTES);

    //persiapan query simpan data
    $simpan = mysqli_query($koneksi, "INSERT INTO tamu VALUES ('','$tgl','$nama','$alamat','$tujuan','$nope', '$nokamar')");
...
<div class="head text-center">
    <img src="assets/img/hotel2-removebg-preview.png" width="300" class="card-body">
                ...
                <form class="user" method="POST" action="">
                    ...
                    <div class="form-group">
                        <input type="number" class="form-control form-control-user" name="nokamar"
                            placeholder="No.Kamar" required>
                    </div>


                    <button type="submit" name="bsimpan" class="btn btn-info btn-user btn-block">Simpan Data</button>
...
<div class="card-body">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <a href="rekapitulasi.php" class="btn btn-info mb-3"><i class="fa fa-table"></i>Rekapitulasi Pengunjung</a>
